...
# import blueprints
from app.routes import rss, scrape, feeds, users, social, auth, bookmarks, read_history, trending, stats, popular, onboarding, tags, feedback
...
app.register_blueprint(popular.bp)
