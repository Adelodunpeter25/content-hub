"""Trending service for popular articles across all users"""
...
def get_trending_articles(days=7, limit=20):
    """Get trending articles based on bookmarks and reads"""
